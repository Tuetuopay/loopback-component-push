...
GcmProvider.prototype._createMessage = function(notification) {
  ...
  // Handle iOS-like alert definition
  if (typeof notification.alert === 'object') {
    message.addNotification('title', notification.alert.title);
    message.addNotification('body', notification.alert.body);
  }
  else {
